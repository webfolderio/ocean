 ...
 * UpdateVpcRequest
 */
@JsonPropertyOrder({ UpdateVpcRequest.JSON_PROPERTY_NAME, UpdateVpcRequest.JSON_PROPERTY_DESCRIPTION,
        UpdateVpcRequest.JSON_PROPERTY_DEFAULT })
public class UpdateVpcRequest {
    ...
    public UpdateVpcRequest name(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateVpcRequest description(String description) {
    ...
    public UpdateVpcRequest _default(Boolean _default) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, updateVpcRequest.name)
                && Objects.equals(this.description, updateVpcRequest.description)
                && Objects.equals(this._default, updateVpcRequest._default);
    }
