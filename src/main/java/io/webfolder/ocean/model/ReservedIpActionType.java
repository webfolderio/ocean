 ...
 */
@JsonPropertyOrder({ ReservedIpActionType.JSON_PROPERTY_TYPE })
...
@JsonSubTypes({ @JsonSubTypes.Type(value = ReservedIpActionAssign.class, name = "assign"),
        @JsonSubTypes.Type(value = ReservedIpActionAssign.class, name = "reserved_ip_action_assign"),
        @JsonSubTypes.Type(value = ReservedIpActionUnassign.class, name = "reserved_ip_action_unassign"),
...
public class ReservedIpActionType {
    ...
    public ReservedIpActionType() {
    }

    public ReservedIpActionType type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    /**
     * Return true if this reserved_ip_action_type object is equal to o.
     */
    @Override
    public boolean equals(Object o) {
        ...
        ReservedIpActionType reservedIpActionType = (ReservedIpActionType) o;
        return Objects.equals(this.type, reservedIpActionType.type);
    }
    ...
    public String toString() {
        ...
        sb.append("class ReservedIpActionType {\n");
    ...
    static {
        ...
        mappings.put("reserved_ip_action_type", ReservedIpActionType.class);
        JSON.registerDiscriminator(ReservedIpActionType.class, "type", mappings);
    }
}