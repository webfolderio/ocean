 ...
 * DatabaseReplica
 */
@JsonPropertyOrder({ DatabaseReplica.JSON_PROPERTY_NAME, DatabaseReplica.JSON_PROPERTY_REGION,
        DatabaseReplica.JSON_PROPERTY_SIZE, DatabaseReplica.JSON_PROPERTY_STATUS, DatabaseReplica.JSON_PROPERTY_TAGS,
        DatabaseReplica.JSON_PROPERTY_CREATED_AT, DatabaseReplica.JSON_PROPERTY_PRIVATE_NETWORK_UUID,
        DatabaseReplica.JSON_PROPERTY_CONNECTION, DatabaseReplica.JSON_PROPERTY_PRIVATE_CONNECTION })
public class DatabaseReplica {
    ...
    @JsonCreator
    public DatabaseReplica(@JsonProperty(JSON_PROPERTY_STATUS) StatusEnum status,
    ...
    public DatabaseReplica name(String name) {
        this.name = name;
        return this;
    }
    ...
    public DatabaseReplica region(String region) {
        this.region = region;
        return this;
    }
    ...
    public DatabaseReplica size(String size) {
        this.size = size;
        return this;
    }
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(example = "db-s-2vcpu-4gb", value = "A slug identifier representing the size of the node for the read-only replica. The size of the replica must be at least as large as the node size for the database cluster from which it is replicating.")
    ...
    public DatabaseReplica tags(List<String> tags) {
        this.tags = tags;
        return this;
    }

    public DatabaseReplica addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public DatabaseReplica privateNetworkUuid(String privateNetworkUuid) {
    ...
    public DatabaseReplica connection(DatabaseReplicaConnection connection) {
    ...
    public DatabaseReplica privateConnection(DatabaseReplicaConnection privateConnection) {
    ...
    /**
     * Return true if this database_replica object is equal to o.
     */
    @Override
    public boolean equals(Object o) {
        ...
        DatabaseReplica databaseReplica = (DatabaseReplica) o;
        return Objects.equals(this.name, databaseReplica.name) && Objects.equals(this.region, databaseReplica.region)
                && Objects.equals(this.size, databaseReplica.size)
                && Objects.equals(this.status, databaseReplica.status)
                && Objects.equals(this.tags, databaseReplica.tags)
                && Objects.equals(this.createdAt, databaseReplica.createdAt)
                && Objects.equals(this.privateNetworkUuid, databaseReplica.privateNetworkUuid)
                && Objects.equals(this.connection, databaseReplica.connection)
                && Objects.equals(this.privateConnection, databaseReplica.privateConnection);
    }
    ...
    public String toString() {
        ...
        sb.append("class DatabaseReplica {\n");
