...
/**
 * ValidateAppRollbackResponseError
 */
@JsonPropertyOrder({ ValidateAppRollbackResponseError.JSON_PROPERTY_CODE,
        ValidateAppRollbackResponseError.JSON_PROPERTY_MESSAGE,
        ValidateAppRollbackResponseError.JSON_PROPERTY_COMPONENTS })
public class ValidateAppRollbackResponseError {
    /**
    ...
    public ValidateAppRollbackResponseError() {
    }

    public ValidateAppRollbackResponseError code(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public ValidateAppRollbackResponseError message(String message) {
    ...
    public ValidateAppRollbackResponseError components(List<String> components) {
        this.components = components;
        return this;
    }

    public ValidateAppRollbackResponseError addComponentsItem(String componentsItem) {
    ...
    /**
     * Return true if this validate_app_rollback_response_error object is equal to
     * o.
     */
    @Override
    public boolean equals(Object o) {
        ...
        ValidateAppRollbackResponseError validateAppRollbackResponseError = (ValidateAppRollbackResponseError) o;
        return Objects.equals(this.code, validateAppRollbackResponseError.code)
                && Objects.equals(this.message, validateAppRollbackResponseError.message)
                && Objects.equals(this.components, validateAppRollbackResponseError.components);
    }
    ...
    public String toString() {
        ...
        sb.append("class ValidateAppRollbackResponseError {\n");
