 ...
 * classes generated from this are immutable and thread-safe.
 * </p>
 *
 * <p>
 * The setter methods of this class return the current object to facilitate a
 * fluent style of configuration.
 * </p>
 */
public class ApiClient {
     ...
     *         parameters, which is encoded for use in a URL. If the value is null,
     ...
     * @param name             The query name parameter.
     * @param values           A collection of values for the given query name,
     *                         which may be null.
     * @return A list of {@link Pair} objects representing the input parameters,
     *         which is encoded for use in a URL. If the values collection is null,
     *         an empty list is returned.
     */
     ...
     *
     * @param port The port of the target service. Set this to -1 to reset the value
     *             to the default for the scheme.
     * @return This object.
     */
     ...
     *
     * <p>
     * A request interceptor is a mechanism for altering each request before it is
     * sent. After the request has been fully configured but not yet built, the
     * request builder is passed into this function for further modification, after
     * which it is sent out.
     * </p>
     *
     * <p>
     * This is useful for altering the requests in a custom manner, such as adding
     ...
     *
     * @return The read timeout, or null if no timeout was set. Null represents an
     *         infinite wait time.
     */
     ...
     *
     * <p>
     * In the case where a new connection needs to be established, if the connection
     * cannot be established within the given {@code
     * duration}, then {@link HttpClient#send(HttpRequest,BodyHandler)
     * HttpClient::send} throws an {@link HttpConnectTimeoutException}, or
     * {@link HttpClient#sendAsync(HttpRequest,BodyHandler) HttpClient::sendAsync}
     * completes exceptionally with an {@code HttpConnectTimeoutException}. If a new
     * connection does not need to be established, for example if a connection can
